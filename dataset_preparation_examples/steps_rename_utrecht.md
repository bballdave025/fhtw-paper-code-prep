...
`$ #find . -type f -iname "*.png | `${{\color{ForestGreen} \texttt{ \quad sed \quad \}} { ' } \color{ForestGreen} \texttt{s|}  {\color{DarkOrange} \mathtt{^{\wedge}\}} {\color{DarkOrange} \texttt{ [ \ \ . \ \ ]/ ' \color{ForestGreen}| \ |g; ' \quad \}}}$` | sort > rename&lt;whatever&gt;.sh`<br/>
