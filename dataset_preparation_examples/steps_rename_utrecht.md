...
`$ #find . -type f -iname "*.png | `${{\color{ForestGreen} \texttt{ \quad sed \quad }} {\color{ForestGreen} \mathtt{\rule{0.5ex}{1.2ex}}} {\color{ForestGreen} \texttt{s|}}  {\color{DarkOrange} \mathtt{^{\wedge}}} {\color{DarkOrange} \texttt{[ \ \ . \ \ ]/ \color{ForestGreen}| \ |g \ ;}}}$` | sort > rename&lt;whatever&gt;.sh`<br/>
